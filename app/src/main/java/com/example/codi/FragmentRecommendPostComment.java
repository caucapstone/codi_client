...
public class FragmentRecommendPostComment extends Fragment {
    RecommendPostActivity activity;
    private RecyclerView recyclerview;

    @Override
    public void onAttach(Context context){
        super.onAttach(context);
        activity = (RecommendPostActivity) getActivity();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState){
        ...
        data.add(new ExpandableListAdapter.Item(ExpandableListAdapter.CHILD, "이런스타일은 어떠세요"));
        // TODO : main comment b
